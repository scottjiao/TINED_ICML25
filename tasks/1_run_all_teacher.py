...
prefix="save_teacher_info";specified_args=["dataset","teacher","exp_setting"]
...
fixed_info={
    ...
    "max_epoch":200,
    "patience":50,
    "save_learned_MLP_info":True,
    "save_results": True,
    "save_teacher_layer_info":True,
    #"verbose":"True",
    "model_config_path":".conf.yaml",
    "output_path":"./results/outputs_with_learned_MLP",
    "teacher":"SAGE",
}
task_space={
